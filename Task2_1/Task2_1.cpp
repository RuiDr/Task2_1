...
CTask21App::CTask21App() noexcept
{
	...
	SetAppID(_T("Task21.AppID.NoVersion"));
...
BOOL CTask21App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CTask21Doc),
		RUNTIME_CLASS(CMainFrame),       // 主 SDI 框架窗口
		RUNTIME_CLASS(CTask21View));
	if (!pDocTemplate)
		return FALSE;
